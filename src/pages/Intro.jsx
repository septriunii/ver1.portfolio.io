...
function Intro() {
  ...
  return (
    ...
    >
      ...
      <div className="p-3 md:w-[70%] lg:w-[75%] bg-zinc-80 flex flex-col lg:p-3 lg:mr-10 lg:ml-5 lg:pt-10 lg:pl-7">
        <p
      ...
      <div
        className={`relative md:py-5 md:ml-2 md:mt-7 flex items-center justify-center lg:w-[35%] lg:mt-3 right-fade-in ${
          isVisible ? "active" : ""
        }`}
      >
        <div
          className={`relative h-[17rem] w-[17rem] lg:h-[25rem] lg:w-[25rem] flex items-center justify-center bg-contain bg-center shrink rounded-full`}
        >
          <SlideshowImage />
