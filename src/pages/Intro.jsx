...
function Intro() {
  ...
  return (
    ...
    >
      ...
      <div
        className={` relative  shrink-0 md:h-[80%] md:w-[30%] md:py-5 md:ml-2 md:mt-7 flex items-center justify-center   lg:flex lg:h-[80%] lg:w-[35%]   lg:mt-3 right-fade-in ${
          isVisible ? "active" : ""
        }`}
      >
        {/* container */}
        <div
          className={`bg-slate-950 relative h-[17rem] w-[17rem] lg:h-[25rem] lg:w-[25rem]  flex items-center justify-center bg-contain bg-center shrink-0 rounded-full`}
        >
          <SlideshowImage />
